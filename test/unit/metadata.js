  ...
  describe('incSides', () => {
    ...
    it('increments both sides by 1 in-place', () => {
      should(docAfterIncSides({})).deepEqual({
        sides: { rev: 1, local: 1, remote: 1 }
      })
      should(docAfterIncSides({ sides: { rev: 1, local: 1 } })).deepEqual({
        sides: { rev: 2, local: 2, remote: 1 }
      })
      should(docAfterIncSides({ sides: { rev: 1, remote: 1 } })).deepEqual({
        sides: { rev: 2, local: 1, remote: 2 }
      })
      should(
        docAfterIncSides({ sides: { rev: 2, local: 2, remote: 2 } })
      ).deepEqual({
        sides: { rev: 3, local: 3, remote: 3 }
      })
      should(
        docAfterIncSides({ sides: { rev: 3, local: 3, remote: 2 } })
      ).deepEqual({
        sides: { rev: 4, local: 4, remote: 3 }
      })
    })
  })
